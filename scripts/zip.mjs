 ...
 *
 * Copied verbatim from grt-bus-time, which is deliberate: it is the same problem
 * with the same answer, and a second implementation would be a second thing to
 * get wrong.
 */
